...
int main()
{
	...
	projection = glm::ortho(0.0f, 800.0f, 0.0f, 600.0f, -1.0f, 1.0f); // Estratégia para usar pixel pois não usa valores negativo
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glViewport(width/2, height/2, width/2, height/2); //inclusão da viewport no loop
